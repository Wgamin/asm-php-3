        ...
        <div class="w-full md:w-1/4">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center">
                <div class="relative inline-block">
                    ...
                    <button class="absolute bottom-0 right-0 bg-white p-2 rounded-full shadow-md border border-gray-100 hover:text-primary-green transition">
                ...
                <div class="space-y-1 text-left">
                    <a href="#" class="flex items-center space-x-3 p-3 rounded-xl bg-green-50 text-primary-green font-bold">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div class="flex justify-end pt-4">
                        <button type="submit" class="bg-[#28a745] hover:bg-dark-green text-white font-bold py-3 px-10 rounded-xl shadow-lg shadow-green-200 transition transform hover:-translate-y-1">
                            Lưu thay đổi
                        </button>
                    </div>
                </form>
