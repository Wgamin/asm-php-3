...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4">
        <h1 class="text-3xl font-bold text-gray-800 mb-8 flex items-center">
            <i class="fas fa-heart text-red-500 mr-3"></i> Danh sách yêu thích của tôi
        </h1>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 transition hover:shadow-md product-card" data-id="{{ $product->id }}">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-emerald-600 font-bold">{{ number_format($product->price) }}đ</span>
        ...
        @else
            <div class="text-center py-20 bg-white rounded-3xl shadow-sm">
                ...
                <p class="text-gray-500 text-lg">Danh sách yêu thích của bạn đang trống.</p>
                <a href="{{ route('home') }}" class="inline-block mt-6 bg-emerald-500 text-white px-8 py-3 rounded-xl font-bold hover:bg-emerald-600 transition">Khám phá sản phẩm</a>
            </div>
        @endif
    </div>
</div>
